...
$value = $departments->findById(['dept_no' => $_GET['id']]);
...
if (isset($_POST['edit'])) {
    ...
    $departments->updatedepartment(['dept_no' => $_GET['id']], $value);
    ...
    <div class="container">
        <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dept_no" name="dept_no" value="<?= $value->dept_no; ?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Last Name</label>
                    <input type="text" class="form-control" name="dept_name" id="dept_name" value="<?= $value->dept_name; ?>">
                </div>
